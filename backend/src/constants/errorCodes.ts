...
export const ErrorCodes = {
  ...
  OFFER_TYPE_REQUIRED: 'OFFER_TYPE_REQUIRED',
  OFFER_INVALID_TYPE: 'OFFER_INVALID_TYPE',
  OFFER_PRICE_REQUIRED: 'OFFER_PRICE_REQUIRED',
  OFFER_INVALID_PRICE: 'OFFER_INVALID_PRICE',
  OFFER_INVALID_DISCOUNT: 'OFFER_INVALID_DISCOUNT',
  OFFER_INVALID_QUANTITY: 'OFFER_INVALID_QUANTITY',
  ...
  OFFER_MAX_PER_USER_EXCEEDED: 'OFFER_MAX_PER_USER_EXCEEDED',
  OFFER_ITEM_REQUIRED: 'OFFER_ITEM_REQUIRED',
  OFFER_ITEM_INVALID_TYPE: 'OFFER_ITEM_INVALID_TYPE',
  OFFER_ITEM_INVALID_QUANTITY: 'OFFER_ITEM_INVALID_QUANTITY',
  OFFER_PURCHASE_NOT_FOUND: 'OFFER_PURCHASE_NOT_FOUND',
  OFFER_PURCHASE_ALREADY_COMPLETED: 'OFFER_PURCHASE_ALREADY_COMPLETED',
