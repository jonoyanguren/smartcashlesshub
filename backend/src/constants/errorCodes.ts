...
export const ErrorCodes = {
  ...
  EVENT_INVALID_IMAGES: 'EVENT_INVALID_IMAGES',
  ...
  PACKAGE_NAME_REQUIRED: 'PACKAGE_NAME_REQUIRED',
  PACKAGE_PRICE_REQUIRED: 'PACKAGE_PRICE_REQUIRED',
  PACKAGE_INVALID_PRICE: 'PACKAGE_INVALID_PRICE',
  PACKAGE_INVALID_QUANTITY: 'PACKAGE_INVALID_QUANTITY',
  PACKAGE_INVALID_DATES: 'PACKAGE_INVALID_DATES',
  PACKAGE_EXPIRED: 'PACKAGE_EXPIRED',
  PACKAGE_SOLD_OUT: 'PACKAGE_SOLD_OUT',
  PACKAGE_INACTIVE: 'PACKAGE_INACTIVE',
  PACKAGE_ALREADY_PURCHASED: 'PACKAGE_ALREADY_PURCHASED',
  PACKAGE_MAX_PER_USER_EXCEEDED: 'PACKAGE_MAX_PER_USER_EXCEEDED',
  PACKAGE_ITEM_REQUIRED: 'PACKAGE_ITEM_REQUIRED',
  PACKAGE_ITEM_INVALID_TYPE: 'PACKAGE_ITEM_INVALID_TYPE',
  PACKAGE_ITEM_INVALID_QUANTITY: 'PACKAGE_ITEM_INVALID_QUANTITY',
  PACKAGE_PURCHASE_NOT_FOUND: 'PACKAGE_PURCHASE_NOT_FOUND',
  PACKAGE_PURCHASE_ALREADY_COMPLETED: 'PACKAGE_PURCHASE_ALREADY_COMPLETED',

  // Reward errors
  REWARD_NOT_FOUND: 'REWARD_NOT_FOUND',
  REWARD_NAME_REQUIRED: 'REWARD_NAME_REQUIRED',
  REWARD_TRIGGER_TYPE_REQUIRED: 'REWARD_TRIGGER_TYPE_REQUIRED',
  REWARD_INVALID_TRIGGER_TYPE: 'REWARD_INVALID_TRIGGER_TYPE',
  REWARD_REWARD_TYPE_REQUIRED: 'REWARD_REWARD_TYPE_REQUIRED',
  REWARD_INVALID_REWARD_TYPE: 'REWARD_INVALID_REWARD_TYPE',
  REWARD_INVALID_AMOUNT: 'REWARD_INVALID_AMOUNT',
  REWARD_INVALID_QUANTITY: 'REWARD_INVALID_QUANTITY',
  REWARD_INVALID_DATES: 'REWARD_INVALID_DATES',
  REWARD_EXPIRED: 'REWARD_EXPIRED',
  REWARD_DEPLETED: 'REWARD_DEPLETED',
  REWARD_INACTIVE: 'REWARD_INACTIVE',
  REWARD_ALREADY_REDEEMED: 'REWARD_ALREADY_REDEEMED',
  REWARD_MAX_REDEMPTIONS_EXCEEDED: 'REWARD_MAX_REDEMPTIONS_EXCEEDED',
  REWARD_REDEMPTION_NOT_FOUND: 'REWARD_REDEMPTION_NOT_FOUND',
  REWARD_USER_NOT_QUALIFIED: 'REWARD_USER_NOT_QUALIFIED',
